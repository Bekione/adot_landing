    ...
    >
      <Link
        ...
        className={cn(
          ...
          'font-ubuntuReg',
          type === "default"
            ? "relative inline-block px-6 py-2 rounded-lg text-white bg-[#503c3c] hover:bg-secondary hover:text-primary transition-all duration-300 overflow-hidden z-50"
