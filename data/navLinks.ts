  ...
  export const navLinks: NavLink[] = [
    ...
    { title: "About Us", href: "/about" },
    {
      ...
      subLinks: [
        ...
        { title: "Adot hERP", description: "Manage your enterprise efficiently.", href: "/products/erp", src: "/images/Adot erp.svg" },
        { title: "CRMk Tool", description: "Boost customer relationships.", href: "/products/crm", src: "/images/Adot crm.svg" },
        { title: "Adotl Ai", description: "Custom ai for Ethiopia", href: "/products/adot-ai", src: "/images/Adot ai.svg" },
      ],
    },
